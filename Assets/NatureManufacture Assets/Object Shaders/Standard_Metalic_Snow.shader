Shader "NatureManufacture Shaders/Standard Shaders/Standard Metalic Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_503_0 = appendResult10_g1;
			float2 uv_DetailMask = i.uv_texcoord * _DetailMask_ST.xy + _DetailMask_ST.zw;
			float4 tex2DNode481 = tex2D( _DetailMask, uv_DetailMask );
			float3 lerpResult479 = lerp( tex2DNode4 , BlendNormals( tex2DNode4 , temp_output_503_0 ) , tex2DNode481.a);
			...
			float4 tex2DNode494 = tex2D( _SnowMaskB, uv0_SnowMaskB );
			float clampResult501 = clamp( ( tex2DNode494.b * _SnowMaskPower ) , 0.0 , 1.0 );
			float3 normalizeResult483 = normalize( BlendNormals( UnpackScaleNormal( tex2D( _BumpMap, uv0_MainTex ), _SnowNormalCoverHardness ) , temp_output_503_0 ) );
